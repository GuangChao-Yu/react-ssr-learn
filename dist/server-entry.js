...
var AppState = (_class = function () {
  function AppState() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { count: 0, name: '于大正正' },
        count = _ref.count,
        name = _ref.name;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', '/Users/Yugc/Yugc/react-webpack-ssr/client/store/app-state.js');
}();
...
// 让mobx 在服务端渲染时不会重复数据变化
(0, _mobxReact.useStaticRendering)(true); // eslint-disable-line
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/Yugc/Yugc/react-webpack-ssr/client/server-entry.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(App, 'App', '/Users/Yugc/Yugc/react-webpack-ssr/client/views/App.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/Yugc/Yugc/react-webpack-ssr/client/config/router.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicList, 'TopicList', '/Users/Yugc/Yugc/react-webpack-ssr/client/views/topic-list/index.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicDetail, 'TopicDetail', '/Users/Yugc/Yugc/react-webpack-ssr/client/views/topic-detail/index.jsx');
}();
...
var TestApi = function (_React$Component) {
  ...
  TestApi.prototype.login = function login() {
    _axios2.default.post('/api/user/login', {
      accessToken: '8fb6f2b3-8521-4951-90ff-613dc6069877'
    }).then(function (resp) {
      console.log(resp);
    }).catch(function (err) {
      console.log(err);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TestApi, 'TestApi', '/Users/Yugc/Yugc/react-webpack-ssr/client/views/test/api-test.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', '/Users/Yugc/Yugc/react-webpack-ssr/client/store/store.js');

  __REACT_HOT_LOADER__.register(createStoreMap, 'createStoreMap', '/Users/Yugc/Yugc/react-webpack-ssr/client/store/store.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/Yugc/Yugc/react-webpack-ssr/client/store/store.js');
}();
